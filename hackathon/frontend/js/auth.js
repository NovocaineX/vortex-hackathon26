...
export async function getAuthToken() {
  ...
  // Demo mode: return a fake token the backend accepts locally
...
export function requireAuth(callback, onCancel) {
  if (currentUser) {
    callback();
  } else {
    showAuthModal(callback, onCancel);
  }
}
...
export function showAuthModal(onSuccess = null, onCancel = null) {
...
export function hideAuthModal() {
  ...
  if (_pendingCallback && currentUser) {
    ...
    cb();
  } else if (!currentUser && _cancelCallback) {
